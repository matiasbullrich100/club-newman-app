...
// resultadosDivision/{categoriaId}. Lo mismo que hace el cron
// (src/app/api/cron/actualizar-resultados-division/route.ts), a mano -- util para poblar Firestore
// la primera vez o para forzar una actualizacion sin esperar al cron.
